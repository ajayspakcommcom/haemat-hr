    ...
    return (
        <>
            ...
            <div className={`card ${classes['zone-wrapper']}`}>
                ...
                <DataTable value={zone} paginator rows={10} rowsPerPageOptions={[2, 4, 6, 8, 10]} header={header} editMode="row" onRowEditComplete={onRowEditComplete} selection={selectedZone} onSelectionChange={onSelectionChange}>
